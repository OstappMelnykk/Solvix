...
See [`docs/RUNNING.md`](docs/RUNNING.md) for how to start the full stack (dev mode with hot reload, or full Docker mode), including Colima/Docker setup and troubleshooting.
